 ...
 * @author 21650
 */
public class ListeEvent extends BaseForm{
    Form current;
    public ListeEvent(Resources res ) {
        ...
        ArrayList<Evenement>list = ServiceEvent.getInstance().affichageEvent();
    ...
    private void addButton(Image img, Evenement rec, Resources res) {
        ...
        Label objetTxt = new Label("Event : "+rec.getNom(),"NewsTopLine2");
        ...
        //click delete icon
       // Import the ServiceEvent class


// Initialize the ServiceEvent instance
ServiceEvent serviceEvent = ServiceEvent.getInstance();

lSupprimer.addPointerPressedListener(l -> {
    // Call the deleteEvenement() method from the ServiceEvent instance
    if(serviceEvent.deleteEvenement(rec.getId())) {
