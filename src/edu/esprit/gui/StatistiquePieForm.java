...
public class StatistiquePieForm extends BaseForm {
    ...
    private double banned = ServiceUtilisateur.verified-ServiceUtilisateur.active;
    private double active = ServiceUtilisateur.active;
...
BaseForm form;
    ...
    public void createPieChartForm() {
        ...
        double total = banned + active;
        
        //values
        double prcntFeed = (banned *100)/total;
        
        double prcntRec = (active * 100)/total;
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Active",prcntRec);
        series.add("Banned",prcntFeed);
