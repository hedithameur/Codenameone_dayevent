...
import edu.esprit.gui.AjoutRMusicForm;
import edu.esprit.gui.GlobalForm;
...
public class ServiceUtilisateur {
    ...
    public void signup(TextField password, TextField email, TextField confirmPassword, TextField nom, TextField prenom, TextField num_tel, Resources res) {
        String url = Statics.BASE_URL + "/api/register?email=" + email.getText().toString()+ "&password=" + password.getText().toString()
    ...
    public void signin(TextField username, TextField password, Resources rs) {
        String url = Statics.BASE_URL + "/api/signin?email=" + username.getText().toString() + "&password=" + password.getText().toString();
    ...
    public void modify(TextField nom, TextField prenom, TextField email, Resources rs) {
        String url = Statics.BASE_URL + "/api/update?id=" + SessionManager.getId() + "&email=" + email.getText().toString()
    ...
    public String getPasswordByEmail(String email, Resources rs) {
        String url = Statics.BASE_URL + "/api/reset?email=" + email;
        req = new ConnectionRequest(url, false);
        req.setUrl(url);
        req.addResponseListener((e) -> {
            JSONParser j = new JSONParser();
    ...
    public void getActive() {
        String url = Statics.BASE_URL + "/api/all";
        req = new ConnectionRequest(url, false);
        req.setUrl(url);
        req.addResponseListener((e) -> {
            JSONParser j = new JSONParser();
