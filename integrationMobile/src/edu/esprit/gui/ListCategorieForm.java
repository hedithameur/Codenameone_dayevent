...
public class ListCategorieForm extends BaseForm{
   ...
   Form current;
    public ListCategorieForm(Resources res ) {
        ...
        ArrayList<Categorie>lis = Servicecategorie.getinstance().afficher();
            for(Categorie rec : lis ) {
    ...
    private void addButton(Image img,Categorie rec , Resources res) {
        ...
        Label objetTxt = new Label("nom  : "+rec.getNomCategorie(),"NewsTopLine2");
     ...
     Label lSupprimer = new Label(" ");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cette musique ?","Annuler","Oui")) {
                ...
                if(Servicecategorie.getinstance().deleteCategorie(rec.getId())) {
        ...
        //    new ModifierCategorieForm(res,rec).show();
        });
