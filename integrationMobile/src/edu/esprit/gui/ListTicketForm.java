...
public class ListTicketForm extends BaseForm{
    ...
    public ListTicketForm(Resources res ) {
        ...
        ArrayList<Ticket>list = ServiceTicket.getInstance().affichageTickets();
    ...
    private void addButton(Image img,Ticket rec , Resources res) {
        ...
        Label prixTxt = new Label("prix du ticket : "+rec.getPrix(),"NewsTopLine2");
        Label nbTxt = new Label("nombre de tickets : "+rec.getNb_tickets(),"NewsTopLine2");
        Label typeTxt = new Label("type du ticket: "+rec.getType(),"NewsTopLine2" );
        Label idETxt = new Label("id evenement : "+rec.getIdEvenement(),"NewsTopLine2" );
        createLineSeparator();
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce ticket?","Annuler","Oui")) {
                ...
                if(ServiceTicket.getInstance().deleteTicket(rec.getId())) {
                    new ListTicketForm(res).show();
                }
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierTicketForm(res,rec).show();
        });
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(idETxt,lModifier,lSupprimer)));
