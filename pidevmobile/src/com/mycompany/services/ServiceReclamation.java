...
public class ServiceReclamation {
    ...
    public void ajoutReclamation(Reclamation reclamation) {
        ...
        String url =Statics.BASE_URL+"/AddReclamation?titre="+reclamation.getTitre()+"&description="+reclamation.getDescription()+"&tel="+reclamation.getTel(); // aa sorry n3adi getId lyheya mech ta3 user ta3 reclamation
    ...
    public ArrayList<Reclamation>affichageReclamations() {
        ...
        String url = Statics.BASE_URL+"/listeJson1";
        req.setUrl(url);
            ...
            public void actionPerformed(NetworkEvent evt) {
                ...
                try {
                    ...
                    for(Map<String, Object> obj : listOfMaps) {
                      ...
                      //  String date_rec = obj.get("date_rec").toString();
                      ...
                      //  re.setId_rec((int)id_rec);
                        //re.setDate_rec(date_rec);
                        re.setTitre(titre);
                        ...
                        //Date 
                      /*String DateConverter =  obj.get("date_rec").toString().substring(obj.get("date_rec").toString().indexOf("timestamp") + 10 , obj.get("date_rec").toString().lastIndexOf("}"));
                        
                        Date currentTime = new Date(Double.valueOf(DateConverter).longValue() * 1000);
                        
                        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
                        String dateString = formatter.format(currentTime);
                        re.setDate_rec(dateString);*/
