...
public class StatistiquePieForm extends BaseForm {
    ...
    private double nbr_reponse = 8;
    private double nbr_reclamation = 23;  
...
theme = UIManager.initFirstTheme("/theme");
        ...
        RadioButton all = RadioButton.createToggle("Les reclamation", barGroup);
       
        all.setUIID("SelectBar");
        RadioButton popular = RadioButton.createToggle("Reclamer", barGroup);
        popular.setUIID("SelectBar");
        RadioButton reponse = RadioButton.createToggle("Les reclamations", barGroup);
        reponse.setUIID("SelectBar");
        ...
        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");
         ...
         popular.addActionListener((e) -> {
          ...
          ListReclamationForm c=new ListReclamationForm(theme);
          c.show();
  ...
  ;       
    ...
    public void createPieChartForm() {
        ...
        double total = nbr_reponse + nbr_reclamation;
        
        //values
        double prcntFeed = (nbr_reponse *100)/total;
        ...
        String []messages = {
            "Statistique reponses % reclamations"
        };
